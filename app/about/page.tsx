...
export default function page() {
  return (
    <div className='px-4 lg:px-24'>
      <div className='mt-14 lg:mt-[145px]'>
      ...
      <div className=''>
        <p className='mt-6 max-w-6xl lg:text-2xl'>
          ...
          digital experiences, I've worked closely with product managers and
          engineers to design and ship applications or softwares that encompass
          an end-to-end experience across a variety of platforms.
        </p>
      </div>
      <div className='mt-6'>
      ...
      <div className='mt-28 flex flex-col items-center justify-between gap-4 pb-8 pt-6 lg:flex-row lg:gap-0 lg:border-t lg:border-[#D9D9D9]'>
        <div className='mt-28'>
          ...
          <div className=''>
            ...
            <div className='mt-20 grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-12 text-[#D9D9D9] font-medium'>
              <h1 className='text-5xl lg:text-[94px] lg:leading-[112px] '>
                01
              </h1>
              <h1 className='text-5xl lg:text-[94px] lg:leading-[112px]'>02</h1>
              <h1 className='text-5xl lg:text-[94px] lg:leading-[112px]'>03</h1>
            </div>
            <div className='grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-12 text-[#D9D9D9] mt-3'>
              <div className='lg:border-t lg:border-[#D9D9D9]'></div>
              <div className='lg:border-t lg:border-[#D9D9D9]'></div>
              <div className='lg:border-t lg:border-[#D9D9D9]'></div>
            </div>
            <div className='grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-12 text-2xl mt-3'>
              <h1>UI/UX designer, Brandux</h1>
              <h1>Product designer, Instaclean</h1>
              <h1>Product design tutor, Codar</h1>
            </div>
          </div>
        </div>
      </div>
      <div className='mt-28 lg:border-t lg:border-[#D9D9D9]'>
        <div className='mt-28 text-4xl lg:max-w-4xl lg:text-[102px] lg:leading-[96px]'>
          Skills and Tools
        </div>
        <div className='mt-12 flex flex-grow gap-20 lg:gap-32 text-[#D9D9D9] font-medium'>
          <h1>Skills</h1>
          {/* <h1>Tools</h1> */}
        </div>
        <div className='mt-6  gap-16 lg:gap-16'>
          {skills.map((skill) => (
            <h1 key={skill.skill}>{skill.skill}</h1>
          ))}
          {/* {tools.map((tool) => (
            <h1 key={tool.tool}>{tool.tool}</h1>
          ))} */}
        </div>
      </div>
    </div>
