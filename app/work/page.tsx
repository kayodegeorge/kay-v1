          ...
          >
            ...
            <div className="mt-8 lg:order-1 lg:col-span-5 lg:mt-0 lg:flex lg:flex-col lg:justify-between">
              ...
              <div className="mt-12 lg:mt-0">
                <Link
                  href="/work"
                  className='relative flex w-fit items-center gap-3 overflow-hidden rounded-full border border-black fill-black px-[24px] py-[14px] before:absolute before:bottom-0 before:left-0 before:right-0 before:top-full before:-z-50 before:bg-bg-lemon before:transition-[top] before:duration-200 before:ease-in before:content-[""] hover:border-bg-lemon hover:fill-white hover:text-white hover:before:top-0'
                >
                  <span className="uppercase">Read case study</span>
