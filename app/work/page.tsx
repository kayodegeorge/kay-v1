...
export default function Work() {
  return (
    <div className='px-4 lg:px-[100px]'>
      <h1 className='mt-6 text-4xl lg:text-[102px] lg:leading-tight'>
        Selected Projects
      </h1>

      <div className='mt-24 space-y-14 border-b border-[#CFCFCF] pb-14'>
        {projects.map((project) => (
          <div
            key={project.title}
            className='border-t border-[#CFCFCF] pt-14 lg:grid lg:grid-cols-12 lg:gap-20'
          >
            <div className='relative h-80 lg:order-2 lg:col-span-7 lg:h-[459px]'>
              <Image
                alt='Project Images'
                src={project.image}
                fill
            ...
            <div className='mt-8 lg:order-1 lg:col-span-5 lg:mt-0 lg:flex lg:flex-col lg:justify-between'>
              <div>
                ...
                <p className='mt-6 text-[#828282]'>{project.description}</p>

                <div className='mt-6 flex flex-wrap gap-2'>
                  {project.tags.map((tag, i) => (
                    <span
                      key={i}
                      className='rounded-full border border-[#CCCCCC] px-4 py-2 uppercase text-[#314263] lg:text-sm'
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className='mt-12 lg:mt-0'>
                <Link
                  href='/work'
                  className='flex w-fit items-center gap-2 rounded-full bg-text-dark px-6 py-4'
                >
