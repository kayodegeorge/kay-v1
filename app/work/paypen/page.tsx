    ...
    <div>
      ...
      <section className="mt-14 px-4 lg:mt-[118px]">
        <div className="mx-auto max-w-4xl">
          ...
          <h2 className="mt-10 text-2xl font-medium lg:text-4xl">Problem</h2>
          ...
          <h2 className="mt-10 text-2xl font-medium lg:text-4xl">Goal</h2>
          <p className="mt-2 lg:text-2xl lg:leading-9">
          ...
          <h2 className="mt-10 text-2xl font-medium lg:text-4xl">Role</h2>
          ...
          <h2 className="mt-10 text-2xl font-medium lg:text-4xl">Sketches</h2>
          <p className="lg:text-2xl lg:leading-9">
        ...
        <div className="mx-auto max-w-4xl">
          <h2 className="mt-10 text-2xl font-medium lg:text-4xl">Wireframes</h2>
          <p className="lg:text-2xl lg:leading-9">
